...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '享受生活的学生', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-lake-pi.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'junlin, 博客', // 网站关键词 英文逗号隔开
